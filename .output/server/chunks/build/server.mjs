import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { mergeProps, unref, createVNode, resolveDynamicComponent, hasInjectionContext, inject, defineComponent, shallowRef, h, resolveComponent, computed, ref, useAttrs, useTemplateRef, onServerPrefetch, getCurrentInstance, toValue, nextTick, toRef, defineAsyncComponent, createElementBlock, provide, cloneVNode, useSSRContext, Suspense, Fragment, createApp, useModel, withCtx, renderSlot, openBlock, createBlock, createTextVNode, toDisplayString, createCommentVNode, mergeModels, watch, renderList, useId, shallowReactive, onErrorCaptured, reactive, effectScope, useSlots, withModifiers, getCurrentScope, isRef, markRaw, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { s as serialize, l as parseQuery, m as hasProtocol, j as joinURL, n as parseURL, o as encodePath, q as decodePath, r as klona, w as withQuery, t as isScriptProtocol, v as defuFn, x as getContext, y as withTrailingSlash, z as withoutTrailingSlash, A as sanitizeStatusCode, B as defu, C as withLeadingSlash, f as createError$1, $ as $fetch$1, D as baseURL, E as createHooks, F as isEqual, G as executeAsync } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BINPb579.mjs')
  },
  {
    name: "clicks",
    path: "/clicks",
    component: () => import('./clicks-CM93NO6Y.mjs')
  }
];
...
const cloudinaryRuntime$aMWabbAfKvH80nJPYBZpIeMI_454YoCqJBnJjlVmyL5dw = defineProvider({
...
const imageOptions = {
  ...
  provider: "cloudinary",
  providers: {
    ["cloudinary"]: { setup: cloudinaryRuntime$aMWabbAfKvH80nJPYBZpIeMI_454YoCqJBnJjlVmyL5dw, defaults: { "baseURL": "https://res.cloudinary.com/dzheectoe/image/upload" } }
  }
};
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    useSeoMeta({
      ...
      description: "Anurag Kumar, undergraduate at NIT Durgapur studying Biotechnology, with 4+ years of experience in web engineering. Specializing in frontend development and building scalable Web3 applications.",
      keywords: "Anurag Kumar, Web Engineer, Frontend Developer, Web3, NIT Durgapur, Biotechnology, Portfolio, JavaScript, React, Next.js, CandyPay",
      author: "Anurag",
      ogTitle: "Anurag | Web Engineer",
      ogDescription: "Undergraduate at NIT Durgapur with 4+ years of web engineering experience. Focused on frontend development and Web3 projects.",
      ogUrl: "https://anurag.tech",
      ogSiteName: "Anurag Kumar Portfolio",
      ogType: "website",
      ogLocale: "en_US",
      ogImage: "https://anurag.tech/bg.webp",
      ogImageWidth: "1536",
      ogImageHeight: "1024",
      ogImageAlt: "Anurag's Portfolio",
      twitterCard: "summary_large_image",
      twitterTitle: "Anurag | Web Engineer",
      twitterDescription: "Frontend-focused web engineer & Web3 enthusiast. Undergraduate at NIT Durgapur.",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-fbtdBsgw.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-B5pctvkk.mjs'));
...
export { __nuxt_component_0$3 as _, _sfc_main$e as a, __nuxt_component_0$1 as b, useRoute as c, entry_default as default, useHead as u };
